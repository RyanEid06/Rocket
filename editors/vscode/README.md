...
The shared server also describes the Rocket 3.0 named/default argument and
labeled-enum metadata, including the bundled graphics/UI signatures. Rocket
3.0 does not fork the editor protocol. Use the current dictionary
