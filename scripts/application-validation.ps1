...
$work = [System.IO.Path]::GetFullPath(
    (Join-Path $outRoot "application-validation\$configurationName"))
...
try {
    ...
    Write-Output "Rocket 2.0 application validation passed: $reportPath"
} finally {
