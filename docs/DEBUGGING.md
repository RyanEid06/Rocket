...
This debugging contract is current for Rocket 3.0.0. The production compiler
remains Rocket source, while CodeView/DWARF,
coverage, profile, and host-process integration remain explicit native tooling
services. Rocket 3.0 does not introduce a separate debugger protocol.
