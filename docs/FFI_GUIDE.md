...
Rocket 3.0.0 is accepted on the four documented production targets. It includes
the reviewed `rocket.raylib.safe` wrapper and typed
graphics/UI modules above this boundary; ordinary application code should use
those wrappers rather than raw generated bindings. The current syntax/API index
is `ROCKET_3_0_SYNTAX_DICTIONARY.md`.
