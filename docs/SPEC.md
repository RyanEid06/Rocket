# Rocket Language Specification through Rocket 1.5
...
version. It records additive language contracts through Rocket 1.5 and the
current Rocket 1.6 package-metadata foundation. Rocket 1.4 and 1.5 add validated
native/library surfaces without introducing new grammar.
