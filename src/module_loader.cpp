...
std::optional<BundledSourceModule> bundledSourceModule(const std::string& name) {
  static const std::map<std::string, BundledSourceModule> modules{
      ...
      {"rocket.graphics.shapes",
       {std::filesystem::path{"rocket"} / "graphics" / "shapes.rocket", "rocket"}},
      {"rocket.graphics.input",
       {std::filesystem::path{"rocket"} / "graphics" / "input.rocket", "rocket"}},
      {"rocket.graphics.canvas",
       {std::filesystem::path{"rocket"} / "graphics" / "canvas.rocket", "rocket"}},
      {"rocket.ui",
       {std::filesystem::path{"rocket"} / "ui.rocket", "rocket"}},
      {"rocket.ui.layout",
       {std::filesystem::path{"rocket"} / "ui" / "layout.rocket", "rocket"}},
      {"rocket.ui.theme",
       {std::filesystem::path{"rocket"} / "ui" / "theme.rocket", "rocket"}},
      {"rocket.ui.styles",
       {std::filesystem::path{"rocket"} / "ui" / "styles.rocket", "rocket"}},
      {"rocket.raylib.safe",
