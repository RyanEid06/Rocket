...
if(run_result EQUAL 20 AND "${run_output}${run_error}" MATCHES "raylib: device or backend unavailable")
  message("SKIP: audio device unavailable; deterministic WP4 package and adapter tests cover the lifecycle")
  return()
endif()
...
message(STATUS "WP4 music, overlapping effects, texture and resized canvas scene rendered")
