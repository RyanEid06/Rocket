if(NOT DEFINED ROCKETC OR NOT DEFINED SOURCE_DIR OR NOT DEFINED WORK OR NOT DEFINED NATIVE_ROOT)
  message(FATAL_ERROR "WP4 audio test is missing required arguments")
endif()

set(package "${SOURCE_DIR}/tests/fixtures/rocket35_audio_package")
file(MAKE_DIRECTORY "${WORK}")
foreach(source IN ITEMS
    "stdlib/rocket/raylib/safe.rocket"
    "stdlib/rocket/raylib/native.rocket"
    "tests/fixtures/rocket35_audio_package/src/main.rocket"
    "tests/fixtures/rocket35_audio_package/testing.rocket"
    "tests/fixtures/rocket35_audio_package/tests/audio_test.rocket")
  ...
  if(NOT format_result EQUAL 0)
    message(FATAL_ERROR "WP4 format check failed for ${source}:\n${format_output}${format_error}")
  endif()
endforeach()
...
if(NOT surface_result EQUAL 0)
  message(FATAL_ERROR "WP4 canonical surface failed:\n${surface_output}${surface_error}")
endif()
...
if(NOT package_result EQUAL 0 OR NOT "${package_output}${package_error}" MATCHES "1 passed; 0 failed")
  message(FATAL_ERROR "WP4 package test failed:\n${package_output}${package_error}")
endif()

message(STATUS "WP4 production audio package passed")
