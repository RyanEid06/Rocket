if(NOT DEFINED ROCKETC OR NOT DEFINED SELFHOST OR NOT DEFINED SOURCE_DIR OR NOT DEFINED WORK)
  message(FATAL_ERROR "WP23 UI-context target-surface test is missing required arguments")
endif()
  ...
  foreach(target IN ITEMS windows-x64 linux-x64 linux-arm64 macos-arm64)
    ...
    if(compiler_name STREQUAL "stage0")
      ...
      if(NOT ir_result EQUAL 0)
        message(FATAL_ERROR "WP23 stage0 target ${target} LLVM lowering failed:\n${ir_output}${ir_error}")
      endif()
    endif()
  endforeach()
endforeach()
message(STATUS "WP23 public UI context source surface passed in stage0/self-host for four targets")
