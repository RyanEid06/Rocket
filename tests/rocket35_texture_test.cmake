if(NOT DEFINED ROCKETC OR NOT DEFINED SOURCE_DIR OR NOT DEFINED WORK OR NOT DEFINED NATIVE_ROOT)
  message(FATAL_ERROR "WP2 texture test is missing required arguments")
endif()

set(package "${SOURCE_DIR}/tests/fixtures/rocket35_texture_package")
file(MAKE_DIRECTORY "${WORK}")
foreach(source IN ITEMS
    "stdlib/rocket/raylib/safe.rocket"
    "stdlib/rocket/raylib/native.rocket"
    "stdlib/rocket/graphics/canvas.rocket"
    "tests/fixtures/rocket35_texture_package/src/main.rocket"
    "tests/fixtures/rocket35_texture_package/testing.rocket"
    "tests/fixtures/rocket35_texture_package/tests/texture_test.rocket")
  ...
  if(NOT format_result EQUAL 0)
    message(FATAL_ERROR "WP2 format check failed for ${source}:\n${format_output}${format_error}")
  endif()
endforeach()

execute_process(COMMAND "${ROCKETC}" check "${package}/src/main.rocket"
...
if(NOT surface_result EQUAL 0)
  message(FATAL_ERROR "WP2 canonical surface failed:\n${surface_output}${surface_error}")
endif()
...
if(NOT package_result EQUAL 0 OR NOT "${package_output}${package_error}" MATCHES "1 passed; 0 failed")
  message(FATAL_ERROR "WP2 package test failed:\n${package_output}${package_error}")
endif()

message(STATUS "WP2 production texture and display package passed")
